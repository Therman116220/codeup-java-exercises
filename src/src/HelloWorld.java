...
//2 ✅
        ...
        /*String myString = "Create a string like this";
        System.out.println(myString);*/
//3 ✅
    /*    char myString = 'C';                     //Example of Incorrect way i guess
        System.out.println(myString);*/
//4 ✅
   /* float myString;
...
// (similar to "Starting point:GO" in board game, or front door of house, you need to walk
// through to access other rooms or ANYTHING)
